...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::QueryParamsResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "Params"));
        ...
        ) -> core::result::Result<tonic::Response<super::QueryDkgRequestResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/DKGRequest");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "DKGRequest"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::QueryDkgRequestsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/DKGRequests");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "DKGRequests"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::QueryDkgCompletionsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/DKGCompletions");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "DKGCompletions"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::QuerySigningRequestResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/SigningRequest");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "SigningRequest"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::QuerySigningRequestsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/SigningRequests");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "SigningRequests"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/RefreshingRequest");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "RefreshingRequest"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Query/RefreshingRequests");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "RefreshingRequests"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/bitway.tss.Query/RefreshingCompletions");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Query", "RefreshingCompletions"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            ...
            match req.uri().path() {
                ...
                "/bitway.tss.Query/DKGCompletions" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Query/SigningRequest" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Query/SigningRequests" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Query/RefreshingRequest" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Query/RefreshingRequests" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Query/RefreshingCompletions" => {
                    #[allow(non_camel_case_types)]
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "bitway.tss.Query";
    }
}
/// Generated client implementations.
#[cfg(feature = "grpc")]
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::MsgCompleteDkgResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Msg/CompleteDKG");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Msg", "CompleteDKG"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::MsgSubmitSignaturesResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Msg/SubmitSignatures");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Msg", "SubmitSignatures"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::MsgRefreshResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Msg/Refresh");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Msg", "Refresh"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Msg/CompleteRefreshing");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Msg", "CompleteRefreshing"));
            self.inner.unary(req, path, codec).await
        }
        ...
        ) -> core::result::Result<tonic::Response<super::MsgUpdateParamsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/bitway.tss.Msg/UpdateParams");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitway.tss.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod msg_server {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            ...
            match req.uri().path() {
                ...
                "/bitway.tss.Msg/SubmitSignatures" => {
                    #[allow(non_camel_case_types)]
                ...
                "/bitway.tss.Msg/CompleteRefreshing" => {
                    #[allow(non_camel_case_types)]
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "bitway.tss.Msg";
    }
}
